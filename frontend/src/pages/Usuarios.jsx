      ...
      <div className="ml-60 flex-1 flex flex-col">
        ...
        <main className="mt-16 p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-slate-800 font-semibold text-lg">Gestión de usuarios</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="text-left px-5 py-3.5 text-slate-500 font-medium">Rol</th>
                  <th className="text-left px-5 py-3.5 text-slate-500 font-medium">Estado</th>
                  <th className="text-left px-5 py-3.5 text-slate-500 font-medium">Registrado</th>
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-medium text-slate-500 uppercase tracking-wide">Rol</label>
                  <select
                    value={form.rol}
