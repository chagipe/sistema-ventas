    ...
    if (existente) {
      setItems(items.map(i =>
        i.producto_id === producto.id
          ? { ...i, cantidad: i.cantidad + parseInt(form.cantidad), subtotal: (i.cantidad + parseInt(form.cantidad)) * i.precio_unitario }
          : i
      ));
    } else {
      setItems([...items, {
        ...
        subtotal: parseFloat(producto.precio) * parseInt(form.cantidad),
      }]);
    }
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-slate-50 rounded-lg p-4 mb-4">
              <p className="text-xs font-medium text-slate-500 uppercase tracking-wide mb-3">Agregar producto</p>
